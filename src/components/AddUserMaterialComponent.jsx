...
class AddUserMaterialComponent extends Component {
    ...
    saveUser = (e) => {
        ...
        if (this.state.nomeVazio === this.state.loginVazio === false) {
            alert('Usuário Salvo!');
        }
    }
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    required
                                    id="login"
                                    name="login" label="Login" value={this.state.login} onChange={this.onChange} helperText={this.state.loginVazio ? "Preencha o campo" : null}
                                    error={this.state.loginVazio}>
                                </TextField>
                            </Grid>
                            <Grid item xs={12}>
                                <TextField
                                    id="idade" type="react-number-format" name="idade" label="Idade" value={this.state.idade} onChange={this.onChange}>
                                </TextField>
                            </Grid>
                            <Grid item xs={12}>
                                <TextField
                                    id="perfil" name="perfil" label="Perfil" value={this.state.perfil}
